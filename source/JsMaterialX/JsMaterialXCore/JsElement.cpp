...
EMSCRIPTEN_BINDINGS(element)
{
    ems::class_<mx::Element>("Element")
        ...
        .function("equals", ems::optional_override([](mx::Element& self, const mx::Element& rhs)
    {
        return self == rhs;
    })).function("notEquals", ems::optional_override([](mx::Element& self, const mx::Element& rhs)
    {
        return self != rhs;
        ...
        .function("getName", &mx::Element::getName) BIND_MEMBER_FUNC("getNamePath", mx::Element, getNamePath, 0, 1, mx::ConstElementPtr)
        ...
        .function("getDocString", &mx::Element::getDocString) BIND_MEMBER_FUNC("addChildOfCategory", mx::Element, addChildOfCategory, 1, 2, stRef, std::string)
        ...
        .function("removeChild", &mx::Element::removeChild) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Backdrop, mx::Backdrop) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Collection, mx::Collection) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Comment, mx::CommentElement) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Generic, mx::GenericElement) BIND_ELEMENT_CHILD_FUNC_INSTANCE(GeomInfo, mx::GeomInfo) BIND_ELEMENT_CHILD_FUNC_INSTANCE(MaterialAssign, mx::MaterialAssign) BIND_ELEMENT_CHILD_FUNC_INSTANCE(PropertySetAssign, mx::PropertySetAssign) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Visibility, mx::Visibility) BIND_ELEMENT_CHILD_FUNC_INSTANCE(GeomPropDef, mx::GeomPropDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Implementation, mx::Implementation) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Look, mx::Look) BIND_ELEMENT_CHILD_FUNC_INSTANCE(LookGroup, mx::LookGroup) BIND_ELEMENT_CHILD_FUNC_INSTANCE(PropertySet, mx::PropertySet) BIND_ELEMENT_CHILD_FUNC_INSTANCE(TypeDef, mx::TypeDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(AttributeDef, mx::AttributeDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(MaterialX, mx::Document) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Node, mx::Node) BIND_ELEMENT_CHILD_FUNC_INSTANCE(NodeDef, mx::NodeDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(NodeGraph, mx::NodeGraph) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Member, mx::Member) BIND_ELEMENT_CHILD_FUNC_INSTANCE(TargetDef, mx::TargetDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Token, mx::Token) BIND_ELEMENT_CHILD_FUNC_INSTANCE(GeomProp, mx::GeomProp) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Input, mx::Input) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Output, mx::Output) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Property, mx::Property) BIND_ELEMENT_CHILD_FUNC_INSTANCE(PropertyAssign, mx::PropertyAssign) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Unit, mx::Unit) BIND_ELEMENT_CHILD_FUNC_INSTANCE(UnitDef, mx::UnitDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(UnitTypeDef, mx::UnitTypeDef) BIND_ELEMENT_CHILD_FUNC_INSTANCE(VariantAssign, mx::VariantAssign) BIND_ELEMENT_CHILD_FUNC_INSTANCE(VariantSet, mx::VariantSet) BIND_ELEMENT_CHILD_FUNC_INSTANCE(Variant, mx::Variant)
    ...
    })).function("validate", ems::optional_override([](mx::Element& self, ems::val message)
    {
        ...
        .function("createValidChildName", &mx::Element::createValidChildName) BIND_MEMBER_FUNC("createStringResolver", mx::Element, createStringResolver, 0, 1, stRef)
