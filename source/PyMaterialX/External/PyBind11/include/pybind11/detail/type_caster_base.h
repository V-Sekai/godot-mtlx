...
class loader_life_support
{
  ...
  public:
    ...
    loader_life_support() :
        parent{ get_stack_top() } { set_stack_top(this); }
                               ...
                               bool throw_if_missing /*= true in common.h*/)
{
    ...
    pybind11_fail("pybind11::detail::instance::get_value_and_holder: `" + get_fully_qualified_tp_name(find_type->type) + "' is not a pybind11 base of the given `" + get_fully_qualified_tp_name(Py_TYPE(this)) + "' instance");
#else
    pybind11_fail(
