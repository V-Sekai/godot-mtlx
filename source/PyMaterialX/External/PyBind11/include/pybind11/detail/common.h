...
#if !defined(NDEBUG) && !defined(PY_ASSERT_GIL_HELD_INCREF_DECREF) && !(defined(PYPY_VERSION) && defined(_MSC_VER)) /* PyPy Windows: pytest hangs indefinitely at the end of the \
                                                                                                                       process (see PR #4268) */                                 \
...
#if defined(__clang__) && (defined(__apple_build_version__)                   /* AppleClang 13.0.0.13000029 was the only data point     \
                                                                                 available. */                                          \
