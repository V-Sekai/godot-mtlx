...
def _addBindInput(self, name, type=DEFAULT_TYPE_STRING):
    ...
    warnings.warn(
        "This function is deprecated; shader references have been replaced with shader nodes in 1.38.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def _addShaderRef(self, name, nodeName):
    ...
    warnings.warn(
        "This function is deprecated; material elements have been replaced with material nodes in 1.38.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def _setGeomAttrValue(self, name, value, typeString=""):
    ...
    warnings.warn(
        "This function is deprecated; call GeomInfo.setGeomPropValue() instead", DeprecationWarning, stacklevel=2
    )
...
def _addMaterial(self, name):
    ...
    warnings.warn(
        "This function is deprecated; call Document.addMaterialNode() instead.", DeprecationWarning, stacklevel=2
    )
...
def _getMaterials(self):
    ...
    warnings.warn(
        "This function is deprecated; call Document.getMaterialNodes() instead.", DeprecationWarning, stacklevel=2
    )
...
def _typeToName(t):
    ...
    warnings.warn(
        "This function is deprecated; call MaterialX.getTypeString instead.", DeprecationWarning, stacklevel=2
    )
...
def _valueToString(value):
    ...
    warnings.warn(
        "This function is deprecated; call MaterialX.getValueString instead.", DeprecationWarning, stacklevel=2
    )
...
def _stringToValue(string, t):
    ...
    warnings.warn(
        "This function is deprecated; call MaterialX.createValueFromStrings instead.", DeprecationWarning, stacklevel=2
    )
