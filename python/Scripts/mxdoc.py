...
def main():
    ...
    parser.add_argument(
        ...
        dest="documentType",
        default="md",
        help='Document type. Default is "md" (Markdown). Specify "html" for HTML output',
    )
    parser.add_argument(
        "--showInherited", default=False, action="store_true", help="Show inherited inputs. Default is False"
    )
