...
def main():
    ...
    parser.add_argument(
        ...
        dest="target",
        default="glsl",
        help='Target shader generator to use (e.g. "glsl, osl, mdl, essl, vulkan"). Default is glsl.',
    )
    parser.add_argument(
        "--outputPath",
        dest="outputPath",
        help="File path to output shaders to. If not specified, is the location of the input document is used.",
    )
    parser.add_argument(
        "--validator",
        dest="validator",
    ...
    parser.add_argument(
        "--vulkanGlsl",
        dest="vulkanCompliantGlsl",
        default=False,
        type=bool,
        help="Set to True to generate Vulkan-compliant GLSL when using the genglsl target.",
    )
    parser.add_argument(
        "--shaderInterfaceType",
        dest="shaderInterfaceType",
        default=0,
        type=int,
        help="Set the type of shader interface to be generated",
    )
